                    ...
                    <tbody>
                        {registrations.map((registration) => (
                            <tr key={registration.id} className="border-b border-gray-50 last:border-0 dark:border-gray-800/60">
                                ...
                                <td className="p-4"><span className={`rounded-full px-3 py-1 text-xs font-semibold ${paymentBadge(registration.paymentStatus)}`}>{getPaymentStatusLabel(registration.paymentStatus)}</span></td>
