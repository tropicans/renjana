                ...
                <div className="space-y-6">
                    <section className="rounded-2xl border border-gray-100 bg-white p-6 dark:border-gray-800 dark:bg-[#1a242f]">
                        ...
                        <div className="mt-5 rounded-2xl bg-slate-50 p-4 text-sm dark:bg-slate-900">
                            <div className="flex items-center justify-between"><span>Online total</span><strong>{formatRupiah(onlineTotal)}</strong></div>
                            <div className="mt-2 flex items-center justify-between"><span>Offline total</span><strong>{formatRupiah(offlineTotal)}</strong></div>
                        </div>
                    </section>
