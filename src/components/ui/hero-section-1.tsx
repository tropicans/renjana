                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">Introducing Renjana LMS</span>
                                    ...
                                    <h1
                                        ...
                                        Empowering Professionals with Tailored <span className="text-primary">Law</span> Training to Build Expertise
                                    </h1>
                                    <p
                                        className="mx-auto mt-8 max-w-2xl text-balance text-lg">
                                        Advanced Learning Orchestration for modern organizations. Practical, engaging, and impactful learning experiences.
                                    </p>
                                </AnimatedGroup>
                                ...
                                <AnimatedGroup
                                    ...
                                    <div
                                        ...
                                        <Button
                                            ...
                                            <Link href="#courses">
                                                <span className="text-nowrap">SEE OUR EXCLUSIVE COURSES</span>
                                            </Link>
                                        </Button>
                                    </div>
                                    <Button
                                        ...
                                        <Link href="#faq">
                                            <span className="text-nowrap">Explore FAQ</span>
                                        </Link>
                                    </Button>
                                </AnimatedGroup>
                            </div>
...
const menuItems = [
    ...
    { name: 'News', href: '/news-and-publications' },
